    ...
    alerts.forEach(function (alert) {
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Doctor of Education</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
          ...
          <div class="card">
                              ...
                              $(document).on('click', '.option', function() {
                                ...
                                <div class="col-6">
                                  <select class="form-control" name="privacy" value="" required>
                                    <option value="" disabled selected>Select Dissertation Privacy</option>
            ...
            @endforeach
              ...
              {{ $doctorEdfiles->links('vendor.pagination.default') }}
            </div>
          </div>
