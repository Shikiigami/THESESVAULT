  ...
  setTimeout(function () {
    ...
    alerts.forEach(function (alert) {
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Diploma in Teaching</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Dissertations Data</h5>
              ...
              <table class="table datatable table-hover">
                ...
                <tbody>
                @foreach ($diplomaInTechfiles as $file)
                    <tr>
                    ...
                    <div class="modal fade" id="editModal_{{ $file->id }}" tabindex="-1">
                      <div class="modal-dialog modal-dialog-centered  modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                          <form action="{{ route('dissertation.update',['id' => $file->id]) }}" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation">
                              @csrf
                              @method('PUT')
                            ...
                            <div class="col-6">
                              ...
                              <select class="form-control" name="program" value=""  >
                                ...
                                <option value="Diploma in Teaching">Diploma in Teaching</option>
            ...
            @endforeach
              ...
              {{ $diplomaInTechfiles->links('vendor.pagination.default') }}
            </div>
          </div>
  ...
  <div class="modal fade" id="verticalycentered" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered  modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="{{ route('dissertation.upload') }}" enctype="multipart/form-data" class="row g-3 needs-validation">
          @csrf
          <div class="col-6">
          ...
          // Function to show search results based on input query
              ...
              <div class="col-6">
                ...
                <div class="col-6">
                  ...
                  <div class="col-4">
                  <label for="abstract"> Acknowledgement:</label>
