...
{{-- end of preloader --}}
  ...
  <div class="pagetitle">
  <h1><img src="{{ asset ('img/ceat.png') }}" alt="ceat" width="50" height="50"> College of Engineering, Architecture and Technology Theses<button type="button"  class="btn btn-primary" style="float:right" data-bs-toggle="modal" data-bs-target="#verticalycentered"><i class="bi bi-upload"></i> Upload</button></h1>
<!-- Place the alerts at the top of your HTML document -->
