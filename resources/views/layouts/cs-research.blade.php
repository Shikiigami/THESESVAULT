          ...
          // Function to show search results based on input query
              ...
              <div class="col-6">
                ...
                <div class="col-6">
                  ...
                  <div class="col-4">
                    <label for="filename"> Thesis PDF file:</label>
                  <input type="file" class="form-control" name="filename" accept=".pdf" value="" required>
                  </div>
                  <div class="col-4">
                    <label for="approvalSheet"> Approval Sheet:</label>
                  <input type="file" class="form-control" name="approvalSheet" accept=".pdf" value="" required>
                  </div>
                    <div class="col-4">
                    <label for="abstract"> Abstract:</label>
