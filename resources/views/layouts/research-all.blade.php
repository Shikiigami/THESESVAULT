...
<body>
  ...
  <div class="pagetitle">
  <h1><img src="{{ asset ('img/rchive.png') }}" alt="img" width="40" height="40"> List of All Theses<button type="button" class="btn btn-primary" style="float:right" data-bs-toggle="modal" data-bs-target="#verticalycentered"><i class="bi bi-upload"></i> Upload</button></h1>
  ...
  <nav>
    ...
    <section class="section dashboard">
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Theses Data<button type="button" class="btn btn-success btn-sm" style="margin-right: 50px; float:right;" data-bs-toggle="modal" data-bs-target="#searchByDate"><i class="bi bi-calendar-check"> </i> Search Date</button></h5>
              <div class="modal fade" id="searchByDate" tabindex="-1">
                  <div class="modal-dialog modal-dialog-centered  modal-m">
                    <div class="modal-content">
                      <div class="modal-header">
                      <h5 class="modal-title"><i class="bi bi-search"></i> Search By Date</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body">
                      <form method="GET" action="{{ route('searchByDate') }}" enctype="multipart/form-data" class="row g-3 needs-validation">
                      <div class="col-6">
