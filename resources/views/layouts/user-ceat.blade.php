...
<head>
  ...
  <title>College of Engineering, Architecture and Technology Research<</title>
...
@include('includes.user-aside')
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1><img src="{{ asset ('img/ceat.png') }}" alt="img" width="40" height="40"> College of Engineering, Architecture and Technology Theses</h1>
    ...
    alerts.forEach(function (alert) {
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">CEAT</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    @foreach ($userCeatfiles as $research)
      ...
      <div class="col-xxl-4 col-md-6">
        <div class="card info-card sales-card">
          ...
          <div class="card-body">
            <h5 class="card-title">{{$research->callno }}<a href="">
            <form action="{{ route('ceat-favorites.add', ['id' => $research->id]) }}" method="POST" style="display: inline;">
            @csrf 
            <button class="fav-button" type="submit">     
            @if ($research->isInFavorites)
                <i class="bi bi-bookmark-check-fill"></i> <!-- Display filled star icon -->
            @else
...
<div class="modal fade" id="fullrequest{{$research->id}}" tabindex="-1">
  ...
  {{ $userCeatfiles->links('vendor.pagination.default') }}
</section>
<script>
