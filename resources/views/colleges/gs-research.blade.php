...
setTimeout(hidePreloader, 1000); 
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1><img src="{{ asset ('img/gs.png') }}" alt="ceat" width="50" height="50"> {{$collegeName}}<button type="button"  class="btn btn-primary" style="float:right" data-bs-toggle="modal" data-bs-target="#verticalycentered"><i class="bi bi-upload"></i> Upload</button></h1>
    ...
    alerts.forEach(function (alert) {
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">GS</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
          ...
          <div class="card">
            ...
            @endforeach
              ...
              {{ $gsfiles->links('vendor.pagination.default') }}
            </div>
          </div>
