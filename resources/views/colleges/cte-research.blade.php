...
setTimeout(hidePreloader, 1000); 
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1><img src="{{ asset ('img/cte.png') }}" alt="ceat" width="50" height="50"> {{$collegeName}}<button type="button"  class="btn btn-primary" style="float:right" data-bs-toggle="modal" data-bs-target="#verticalycentered"><i class="bi bi-upload"></i> Upload</button></h1>
      ...
      <div class="row">
          ...
          <div class="card">
            ...
            @endforeach
              ...
              {{ $ctefiles->links('vendor.pagination.default') }}
            </div>
          </div>
